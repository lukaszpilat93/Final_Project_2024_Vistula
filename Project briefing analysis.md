...
forward the delivery to our final client. For more information about the various segment types, please go to the chapter [First steps with Trados - how to start](First steps with Trados - how to start/First steps with Trados - how to start.md).
